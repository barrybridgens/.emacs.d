...
** Refile
#+begin_src emacs-lisp
  (setq org-refile-targets '(("~/Dropbox/Documents/org/todos.org" :maxlevel . 2)
                             ))
#+end_src
* Projectile
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
          (defun bjb-journal-new-entry ()
            ...
            (interactive)
            (switch-to-buffer "journal2022.org")
            (goto-char (point-max))
...
* Register setup
#+begin_src emacs-lisp
  (set-register ?j (cons 'file (concat org-directory "/journal2022.org")))
  (set-register ?n (cons 'file (concat org-directory "/notes.org")))
  (set-register ?t (cons 'file (concat org-directory "/todos.org")))
  (set-register ?p (cons 'file (concat org-directory "/photography.org")))
